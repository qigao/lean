...
-- The well-founded sort is evaluated through proved equations by decide_cbv;
-- this is proof-producing computation, not native evaluation.
...
example : (encoded 1).edges =
    #[(0,1),(0,2),(0,3),(0,4),(1,2),(1,3),(1,5),(2,4),(2,5)] := by decide_cbv
example : (encoded 2).nodeCount = 15 := by decide_cbv
example : (encoded 2).edges.size = 27 := by decide_cbv
example : (encoded 3).nodeCount = 42 := by decide_cbv
example : (encoded 3).edges.size = 81 := by decide_cbv

example : encodingWellFormed (encoded 0) := by decide
example : encodingWellFormed (encoded 1) := by decide_cbv
example : encodingWellFormed (encoded 2) := by decide_cbv
example : encodingWellFormed (encoded 3) := by decide_cbv
